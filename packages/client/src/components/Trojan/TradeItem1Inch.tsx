...
export default function TradeItem1Inch({
  tx,
  currency,
  initOpen,
  clearTxHandler = null,
          ...
          <RowBetween>
            {cid === toTokenAddress ? (
              ...
              <>
                ...
                >
                  {'Sell ▼ '}{' '}
                  {cf.symbol === 'WETH9' ? 'WETH ' : cf.symbol + ' '}
                  <b>
                    {' '}
                    {
                      <FormattedCurrencyAmount
              ...
              <>
                {whaleData !== {} && (
                  <ClickableText
                    ...
                    onClick={() => setShowMe(!showMe)}
                  >
                    {'Known ' + '...' + whaleData.address.slice(36, 42)}{' '}
                    <Monitor color={theme.yellow1} size={14} />
                  </ClickableText>
                )}
              </>
            )}
            ...
            <Text
              fontSize={12}
              color={isV3 ? theme.blue1 : isV2 ? theme.green1 : theme.yellow1}
            >
              {isV2_1Inch && '1InchV2'}
              {isV3_1Inch && '1InchV3'}
              {isV2 && ' -> V2'}
