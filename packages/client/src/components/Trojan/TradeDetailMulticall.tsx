...
export default function TradeDetailMulticall({
  tx,
  showMe,
  tradeType,
}: TradeDetailProps) {
    ...
    <TradeDetailShow show={showMe}>
        ...
        <>
          {whaleData !== {} && (
            <RowBetween align="center" style={{ marginTop: '0.3rem' }}>
              ...
              >
                {'Known ' +
                  whaleData.address.slice(0, 5) +
                  '...' +
                  whaleData.address.slice(36, 42)}{' '}
              </ExternalLink>
              <ExternalLink
                style={{ color: '#674acf' }}
                href={'https://twitter.com/' + whaleData.twitter.handle}
              >
      ...
      <RowBetween align="center" style={{ marginTop: '0.2rem' }}>
        ...
        <Text fontWeight={500} fontSize={12}>
          {gasPrice && utils.formatUnits(Number(gasPrice), 'gwei').slice(0, 6)}{' '}
          Gwei
        </Text>
      </RowBetween>
      ...
      <RowBetween align="center" style={{ marginTop: '0.5rem' }}>
        <ExternalLink
          style={{ fontSize: '13px', color: '#674acf' }}
          href={'https://etherscan.io/address/' + from}
        >
