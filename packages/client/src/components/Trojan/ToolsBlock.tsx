            ...
            >
              <OutlineCard99>
                ...
                <Text color={'#5aea98'} fontWeight={800} fontSize={14}>
                  <FadeIn
                    text={
                      block.responseData.blockPrices[0].estimatedPrices[0]
                        .price + ' Gwei'
                    }
                  ></FadeIn>
                </Text>
              ...
              <OutlineCard95>
                ...
                <Text color={'#5dea5a'} fontWeight={800} fontSize={14}>
                  <FadeIn
                    text={
                      block.responseData.blockPrices[0].estimatedPrices[1]
                        .price + ' Gwei'
                    }
                  ></FadeIn>
                </Text>
              ...
              <OutlineCard90>
                ...
                <Text color={'#bcea5a'} fontWeight={800} fontSize={14}>
                  <FadeIn
                    text={
                      block.responseData.blockPrices[0].estimatedPrices[2]
                        .price + ' Gwei'
                    }
                  ></FadeIn>
                </Text>
              ...
              <OutlineCard80>
                ...
                <Text color={'#ffe600'} fontWeight={800} fontSize={14}>
                  <FadeIn
                    text={
                      block.responseData.blockPrices[0].estimatedPrices[3]
                        .price + ' Gwei'
                    }
                  ></FadeIn>
                </Text>
              ...
              <OutlineCard70>
                ...
                <Text color={'#eab05a'} fontWeight={800} fontSize={14}>
                  <FadeIn
                    text={
                      block.responseData.blockPrices[0].estimatedPrices[4]
                        .price + ' Gwei'
                    }
                  ></FadeIn>
                </Text>
        ...
        <LightGreyCardDark>
          ...
          <RowBetween align="center" style={{ marginBottom: '0.2rem' }}>
            ...
            >
              <FadeIn
                text={
                  block.responseData.blockPrices[0].estimatedTransactionCount +
                  ' TXs'
                }
              ></FadeIn>
            </ExternalLink>
